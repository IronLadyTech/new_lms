...
export const BM100_SUBMISSION_SPEC = {
  'bm100-wk1-4': { method: BM100_SUBMISSION_METHOD.TEMPLATE, note: 'Core Brand Story' },
  ...
  'bm100-wk1-1': { method: BM100_SUBMISSION_METHOD.TEMPLATE, note: 'Milestone Table' },
  'bm100-wk1': { method: BM100_SUBMISSION_METHOD.TEMPLATE, note: 'Core Brand Video Script' },
  ...
  'bm100-wk5': { method: BM100_SUBMISSION_METHOD.TEMPLATE, note: 'Theme Table' },
  ...
  'bm100-wk9': { method: BM100_SUBMISSION_METHOD.TEMPLATE, note: 'Pitch document' },
  'bm100-wk10': { method: BM100_SUBMISSION_METHOD.VIDEO },
  'bm100-wk11': { method: BM100_SUBMISSION_METHOD.VIDEO },
  'bm100-wk12': { method: BM100_SUBMISSION_METHOD.TEMPLATE, note: 'Strategy problem statement' },
  'bm100-wk13': { method: BM100_SUBMISSION_METHOD.TEMPLATE, note: 'Strategy document' },
  'bm100-wk14': { method: BM100_SUBMISSION_METHOD.TEMPLATE, note: 'Updated strategy' },
  ...
  'bm100-wk19': { method: BM100_SUBMISSION_METHOD.TEMPLATE, note: 'Super Power mapping' },
  'bm100-wk20': { method: BM100_SUBMISSION_METHOD.TEMPLATE, note: 'Milestone Table' },
